...
class WaveFusionDiscriminator(nn.Module):
    ...
    def __init__(self,
                 ...
                 lambda_freq: float = 0.0,   # set >0 to enable freq head contribution
                 freq_base_c: int = 32):
        super().__init__()
        ...
        self.freq_head = HaarHFHead(in_channels, base_c=freq_base_c) if lambda_freq > 0 else None
